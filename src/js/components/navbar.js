        ...
        `<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item ms-2 me-2"><a class="nav-link" href="./actives.html">Activos</a></li>
                    <li class="nav-item ms-2 me-2"><a class="nav-link" href="./spares.html">Refacciones</a></li>
                    <li class="nav-item ms-2 me-2"><a class="nav-link" href="./suppliers.html">Proveedores</a></li>
                    <li class="nav-item ms-2 me-2"><a class="nav-link" href="./tasks.html">Tareas</a></li>
                    <li class="nav-item ms-2 me-2"><a class="nav-link" href="./planning.html">Planeación</a></li>
                </ul>
            </div>
